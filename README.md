...
bashgit clone https://github.com/Lux-8/ai-coach.git
cd ai-coach
...
You pick a subject, grade, and prep type from the sidebar
The system builds a prompt matching the real ВПР/ВсОШ format for that grade
YandexGPT generates a task in the style of real exam/olympiad archives
After your answer — feedback + the next task of a different type, to keep it varied
